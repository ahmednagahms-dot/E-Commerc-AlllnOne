    ...
    <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
      ...
      <div className="flex gap-2">
        ...
        <button
          type="button"
          onClick={addTag}
          className="bg-gray-700 hover:bg-gray-800 text-white rounded-lg w-10 flex items-center justify-center shrink-0 cursor-pointer"
        >
          <Plus size={18} />
        </button>
      </div>
