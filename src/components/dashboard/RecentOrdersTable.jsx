  ...
  return (
    <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 lg:col-span-2">
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={() => navigate("/dashboard/orders")} className="text-xs text-primary-500">View all orders</button>
      </div>
            ...
            {orders.length === 0 ? (
              ...
              orders.map((o) => (
                <tr key={o._id} className="border-b last:border-0 cursor-pointer hover:bg-gray-50" onClick={() => navigate("/dashboard/orders")}>
                  ...
                  <td className="py-3 text-gray-500">{new Date(o.createdAt).toLocaleDateString("en-US", { month: "short", day: "numeric" })}</td>
